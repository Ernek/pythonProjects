...
# Use a list of 9 elements to represent the tic-tac-toe board
#   1 | 2 | 3
#   4 | 5 | 6 
#   7 | 8 | 9 

# First player gets the X
# Second player gets the O

# Use OOP 
# We need 3 clases: 
# Board: to handle the board and winning / draw logic
# Player: to handle player names and symbols they use
# Game: to handle game logic
...
class Game:
    ...
    # this method will be used to play the game
    def play(self):
